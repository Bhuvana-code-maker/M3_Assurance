...
def upgrade() -> None:
    op.create_table(
        ...
        sa.Column("regions", sa.ARRAY(sa.String(64)), nullable=False, server_default="{}"),
    ...
    op.create_table(
        ...
        sa.Column("framework_id", sa.String(64), sa.ForeignKey("frameworks.framework_id"), nullable=False),
        sa.Column("category", sa.String(255), nullable=False),
        sa.Column("name", sa.String(512), nullable=False),
        sa.Column("description", sa.Text),
        sa.Column("attack_mapping", sa.ARRAY(sa.String(32)), nullable=False, server_default="{}"),
    )
    ...
    op.create_table(
        ...
        sa.Column("control_id", sa.String(64), sa.ForeignKey("controls.control_id"), nullable=False),
    ...
    op.create_index("ix_control_statuses_engagement", "control_statuses", ["engagement_id"])
    ...
    op.create_index("ix_resilience_scores_engagement", "resilience_scores", ["engagement_id"])
    ...
    op.create_table(
        "cross_walks",
        sa.Column("id", sa.BigInteger, primary_key=True, autoincrement=True),
        sa.Column("source_control_id", sa.String(64), sa.ForeignKey("controls.control_id"), nullable=False),
        sa.Column("target_control_id", sa.String(64), sa.ForeignKey("controls.control_id"), nullable=False),
